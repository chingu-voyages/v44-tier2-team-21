const Instructions = () => {
  return (
    <div className="flex flex-col justify-center items-center text-[#ffffff] text-xs mx-auto w-5/6">
      <ol>
        <li>
          Add bots by entering a name, a color, and then selecting their boolean
          value, initial direction of movement, and their opertation. You can
          add up to four bots.
        </li>
        <li>
