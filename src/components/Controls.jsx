...
const Controls = () => {
  ...
  return (
    <div className='w-full h-full bg-[#1E1E1E] text-[#FFFFFF] text-center border-4 rounded-md border-[#FF0000] max-w-sm'>
      <h2 className='mb-10 text-2xl pt-5'>GAME CONFIGURATION</h2>
      <button className='px-9 py-2 rounded-full bg-[#D9D9D9] text-[#000000]'>
        + Add Bot
      </button>
      <div className='panel-to-show-hide'>
        ...
        <form className='bot-config border rounded-xl p-2 m-3'>
          ...
          <button className='border rounded-xl px-4 py-1'>
            SAVE
          </button>
        </form>
      </div>
